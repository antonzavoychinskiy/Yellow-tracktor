 ...
 * (2026-09-хх, 31 замер в покое): фактический центр сместился на
 * X≈1849, Y≈1815 — видимо, потенциометры физически сдвинулись/повёрнуты
 * при монтаже в корпус. TODO(stand): перепроверить, если корпус ещё
 * раз разберут — крепление джойстика явно не жёстко фиксирует ноль. */
#define MODULE_JOYSTICK_ADC_CENTER_X       1849
#define MODULE_JOYSTICK_ADC_CENTER_Y       1815
